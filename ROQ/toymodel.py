...
TS_size = 2000
f0s = np.random.rand(TS_size)*0.002-0.001
f1s = np.random.rand(TS_size)*(2e-9)-1e-9
...
f0s_rand = np.random.rand(TS_rand_size)*0.002-0.001
f1s_rand = np.random.rand(TS_rand_size)*(2e-9)-1e-9
